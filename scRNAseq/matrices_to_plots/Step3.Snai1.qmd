...
wd <- "~/script/allScriptsFromMayranEtAl2025/"
...
new.cluster.name <- c("Som. Mes.","NMP 2", "Neural Tube 1", "Prim. Streak",
                      "NMP 1", "Caudal Epiblast","Pharyngeal Mesoderm",
                      "Post. PSM", "Epiblast", "Neuron Progen.",
                      "Ant. PSM","Sclerotome", "Endoderm 2",
                      "Neural Tube 2", "Pluripotent", "Neuron Precursor",
                      "Ant. Prim. Streak", "Endoderm 1", "Surface Ectoderm",
                      "Endothelial")
...
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "BarPlot.Snai1")
...
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "Transitory.featurePlot")
genelist <- c("T", "Fst", "Sp8")
for(gene in genelist){
  g <- featurePlotMayran("combined.seurat", gene, params, split.by = "Genotype2", by.rows = T, width = 6, height = 15)
  print(g)
}
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "PSM.featurePlot")
genelist <- c("Tbx6", "Msgn1", "Pcdh19")
for(gene in genelist){
  g <- featurePlotMayran("combined.seurat", gene, params, split.by = "Genotype2", by.rows = T, width = 6, height = 15)
  print(g)
}
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "Pluripotent.featurePlot")
genelist <- c("Dppa5a", "Zfp42", "Pou5f1")
for(gene in genelist){
  g <- featurePlotMayran("combined.seurat", gene, params, split.by = "Genotype2", by.rows = T, width = 6, height = 15)
  print(g)
}
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "Som.Mes.featurePlot")
genelist <- c("Pax3", "Tcf15", "Meox2", "Pax1")
for(gene in genelist){
  g <- featurePlotMayran("combined.seurat", gene, params, split.by = "Genotype2", by.rows = T, width = 6, height = 15)
  print(g)
}
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "Neuronal.featurePlot")
...
params$current.fig <- SwitchFigure(Fig = "S5", Panel = "Reviewer")
genelist <- c("Wnt3", "Wnt3a", "Nodal", "Fgf4", "Fgf8", "Fgf5",
              "Aldh1a2", "Cyp26a1", "Otx2", "Fgf5")
for(gene in genelist){
  g <- featurePlotMayran("combined.seurat", gene, params, split.by = "Genotype2", by.rows = T, width = 6, height = 15)
  print(g)
}
